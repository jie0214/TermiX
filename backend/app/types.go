...
type KubernetesResourceEventsRequest = dto.KubernetesResourceEventsRequest
type KubernetesResourceEvents = dto.KubernetesResourceEvents
type KubernetesSecretValueRequest = dto.KubernetesSecretValueRequest
type KubernetesSecretValue = dto.KubernetesSecretValue
...
type KubernetesServicePortForwardRequest = dto.KubernetesServicePortForwardRequest
type KubernetesServicePortForwardListRequest = dto.KubernetesServicePortForwardListRequest
...
type KubernetesResourceScaleRequest = dto.KubernetesResourceScaleRequest
