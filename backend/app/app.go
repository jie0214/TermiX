...
func NewApp(termMgr *terminal.Manager, ctrlPanel *controlpanel.Executor, sshConn *termixssh.Connector, snippetsSvc *snippets.Service, hostVaultSvc *hostvault.Service, kubernetesSvc *kubernetes.Service) *App {
	return &App{
		terminal:     termMgr,
